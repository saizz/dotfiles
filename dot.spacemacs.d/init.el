  ...
  (setq-default
   ...
   '(
     ...
     (multiple-cursors :variables
                       ...
                       mc/cmds-to-run-onve '(upcase-region))
     org
     (shell :variables
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "M-m")
   dotspacemacs-emacs-leader-key (if window-system "<C-return>" "M-m")
...
before packages are loaded."
  ...
  (global-set-key (kbd "<henkan>") #'mozc-temp-convert-dwim)
  ...
  ;; split horizontally or vertically automatically
  (defun split-window-automatically ()
    (interactive)
    (if (> (window-width) (* 2.5 (window-height)))
        (split-window-horizontally)
      (split-window-vertically)))
  (global-set-key (kbd "C-c w") 'split-window-automatically)

  ;; move forcus window by ctrl + arrow keys
